...
insert into users(user_id, fullname, contact, region_id, password, gender) values ('1','Moxina', '998909191123', '3', '7397', 'female');
insert into users(user_id, fullname, contact, region_id, password, gender) values ('2','Maxim', '998901112233', '2', '7397', 'male');
insert into users(user_id, fullname, contact, region_id, password, gender) values ('3','Akmal', '998903332211', '4', '7397', 'male');
insert into users(user_id, fullname, contact, region_id, password, gender) values ('4','Nodira', '998904445566', '7', '7397', 'female');
insert into users(user_id, fullname, contact, region_id, password, gender) values ('5','Toxir', '998996142005', '1', '7397', 'male');

insert into universities(university_id ,university_name, region_id) 
values 
...
insert into faculties(faculty_id, grant_count, contract_count ,faculty_name, first_subject, second_subject, passing_score_grant, passing_score_contract, university_id) 
values 
